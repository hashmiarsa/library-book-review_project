...
// var slides = document.querySelectorAll(".slide"); // Fetches all slides
// var arraySlides = Array.from(slides); // Converts NodeList to an array
// // var dots = Array.from(document.querySelectorAll(".dot")); // Select all dots and convert to an array

// let currentIndex = 0;

// function showSlide(index) {
//     arraySlides.forEach(elem => {
//         elem.style.display = "none"; // Hide all slides
//     });
//     arraySlides[index].style.display = 'block'; // Show the current slide
...
//     currentIndex = (currentIndex - 1 + arraySlides.length) % arraySlides.length;
//     showSlide(currentIndex);
// });

// right_button.addEventListener("click", function() {
//     currentIndex = (currentIndex + 1) % arraySlides.length;
//     showSlide(currentIndex);
// });
